        ...
        final ArrayList<TouristItem> destinations = new ArrayList<TouristItem>() {
            {
                ...
                add(new TouristItem(R.drawable.res_la, "Langos", "Greasy, tasty streetfood, found all over the city.", "https://www.google.com/maps/search/?api=1&query=47.4926316, 19.0438466", "+3613663300", "https://en.wikipedia.org/wiki/L%C3%A1ngos"));
